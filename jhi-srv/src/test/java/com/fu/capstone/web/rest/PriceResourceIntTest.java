...
public class PriceResourceIntTest {
    ...
    private static final Boolean DEFAULT_MULTIPLY = false;
    private static final Boolean UPDATED_MULTIPLY = true;
    ...
    public void createPrice() throws Exception {
        ...
        assertThat(testPrice.getWeight()).isEqualTo(DEFAULT_WEIGHT);
        assertThat(testPrice.getPrice()).isEqualTo(DEFAULT_PRICE);
        assertThat(testPrice.isMultiply()).isEqualTo(DEFAULT_MULTIPLY);
        assertThat(testPrice.getCreateDate()).isEqualTo(DEFAULT_CREATE_DATE);
        assertThat(testPrice.getUpdateDate()).isEqualTo(DEFAULT_UPDATE_DATE);
    }
    ...
    public void getAllPrices() throws Exception {
        ...
        restPriceMockMvc.perform(get("/api/prices?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].multiply").value(hasItem(DEFAULT_MULTIPLY.booleanValue())))
    ...
    public void getPrice() throws Exception {
        ...
        restPriceMockMvc.perform(get("/api/prices/{id}", price.getId()))
            ...
            .andExpect(jsonPath("$.multiply").value(DEFAULT_MULTIPLY.booleanValue()))
    ...
    public void updatePrice() throws Exception {
        ...
        Price testPrice = priceList.get(priceList.size() - 1);
        assertThat(testPrice.getWeight()).isEqualTo(UPDATED_WEIGHT);
        assertThat(testPrice.getPrice()).isEqualTo(UPDATED_PRICE);
        assertThat(testPrice.isMultiply()).isEqualTo(UPDATED_MULTIPLY);
        assertThat(testPrice.getCreateDate()).isEqualTo(UPDATED_CREATE_DATE);
        assertThat(testPrice.getUpdateDate()).isEqualTo(UPDATED_UPDATE_DATE);
    }

...
public class WarehouseTransferRequestResource {
    ...
    @Timed
    public ResponseEntity<WarehouseTransferRequestDTO> createWarehouseTransferRequest(@RequestBody WarehouseTransferRequestDTO warehouseTransferRequestDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<WarehouseTransferRequestDTO> updateWarehouseTransferRequest(@RequestBody WarehouseTransferRequestDTO warehouseTransferRequestDTO) throws URISyntaxException {

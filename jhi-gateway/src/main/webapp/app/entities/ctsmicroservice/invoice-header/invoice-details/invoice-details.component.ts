...
export class InvoiceDetailsComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.invoiceDetailsService
            ...
            .subscribe(
                (res: HttpResponse<IInvoiceDetails[]>) => this.paginateInvoiceDetails(res.body, res.headers),
    ...
    registerChangeInInvoiceDetails() {
        this.eventSubscriber = this.eventManager.subscribe('invoiceDetailsListModification', response => this.loadAll());
    }
    ...
    private paginateInvoiceDetails(data: IInvoiceDetails[], headers: HttpHeaders) {

...
public class MailService {
    ...
    @Async
    public void sendEmailAndContentFromTemplate(UserDTO customer, UserDTO employee, InvoiceHeaderDTO invoiceHeader,
                                                ReceiptNoteDTO receipt, String templateName, String titleKey) {
        Locale locale = Locale.forLanguageTag(customer.getLangKey());
        Context context = new Context(locale);
        context.setVariable("customer", customer);
        context.setVariable("employee", employee);
        context.setVariable("receipt", receipt);
        context.setVariable("invoiceHeader", invoiceHeader);
        context.setVariable(BASE_URL, jHipsterProperties.getMail().getBaseUrl());
        String content = templateEngine.process(templateName, context);
        String subject = messageSource.getMessage(titleKey, null, locale);
    ...
    @Async
    public void sendNotifyShipmentEmail(
        UserDTO shipper, PersonalShipmentDTO shipment, InvoiceHeaderDTO invoice, String templateName, String titleKey
    ) {
        Locale locale = Locale.forLanguageTag(shipper.getLangKey());
        Context context = new Context(locale);
        context.setVariable("shipper", shipper);

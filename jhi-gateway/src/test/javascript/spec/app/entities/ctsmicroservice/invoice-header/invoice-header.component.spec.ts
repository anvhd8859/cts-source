...
import { InvoiceHeaderComponent } from 'app/entities/ctsmicroservice/invoice-header/invoice-header.component';
...
describe('Component Tests', () => {
    describe('InvoiceHeader Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.invoiceHeaders[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });

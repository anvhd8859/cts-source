...
describe('Service Tests', () => {
    describe('SubDistrict Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SubDistrictService);
            httpMock = injector.get(HttpTestingController);
            currentDate = moment();

            elemDefault = new SubDistrict(0, 'AAAAAAA', currentDate, currentDate);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a SubDistrict', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        createDate: currentDate.format(DATE_TIME_FORMAT),
            ...
            it('should update a SubDistrict', async () => {
                const returnedFromService = Object.assign(
                    {
                        subDistrictName: 'BBBBBB',
                        createDate: currentDate.format(DATE_TIME_FORMAT),
                        updateDate: currentDate.format(DATE_TIME_FORMAT)
                    },
                    elemDefault
            ...
            it('should return a list of SubDistrict', async () => {
                const returnedFromService = Object.assign(
                    {
                        subDistrictName: 'BBBBBB',
                        createDate: currentDate.format(DATE_TIME_FORMAT),
            ...
            it('should delete a SubDistrict', async () => {

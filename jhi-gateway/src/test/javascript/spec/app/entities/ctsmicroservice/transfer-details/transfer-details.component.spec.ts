...
import { TransferDetailsComponent } from 'app/entities/ctsmicroservice/transfer-details/transfer-details.component';
...
describe('Component Tests', () => {
    describe('TransferDetails Management Component', () => {
        let comp: TransferDetailsComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TransferDetailsComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.transferDetails[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });

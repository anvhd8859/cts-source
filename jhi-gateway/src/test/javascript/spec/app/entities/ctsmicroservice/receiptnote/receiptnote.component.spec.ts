...
describe('Component Tests', () => {
    describe('Receiptnote Management Component', () => {
        let comp: ReceiptnoteComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ReceiptnoteComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.receiptnotes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });

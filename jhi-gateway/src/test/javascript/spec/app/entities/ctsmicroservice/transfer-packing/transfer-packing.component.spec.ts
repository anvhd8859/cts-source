...
describe('Component Tests', () => {
    describe('TransferPacking Management Component', () => {
        let comp: TransferPackingComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TransferPackingComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.transferPackings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });

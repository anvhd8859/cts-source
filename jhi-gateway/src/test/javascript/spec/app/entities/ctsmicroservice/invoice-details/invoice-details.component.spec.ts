...
describe('Component Tests', () => {
    describe('InvoiceDetails Management Component', () => {
        let comp: InvoiceDetailsComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(InvoiceDetailsComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.invoiceDetails[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });

...
describe('Service Tests', () => {
    describe('RequestDetails Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new RequestDetails(0, 0, 0, currentDate, currentDate);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a RequestDetails', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        createDate: currentDate.format(DATE_TIME_FORMAT),
                ...
                service
                    .create(new RequestDetails(null))
                    .pipe(take(1))
            ...
            it('should update a RequestDetails', async () => {
                const returnedFromService = Object.assign(
                    {
                        ieWarehouseId: 1,
                        invoiceHeaderId: 1,
            ...
            it('should return a list of RequestDetails', async () => {
                const returnedFromService = Object.assign(
                    {
                        ieWarehouseId: 1,
                        invoiceHeaderId: 1,
            ...
            it('should delete a RequestDetails', async () => {

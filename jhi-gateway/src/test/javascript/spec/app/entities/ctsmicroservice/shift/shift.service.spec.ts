...
import { IShift, Shift } from 'app/shared/model/ctsmicroservice/shift.model';
...
describe('Service Tests', () => {
    describe('Shift Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Shift(0, 'AAAAAAA', 0, 0, 0, 0, currentDate, currentDate);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of Shift', async () => {
                const returnedFromService = Object.assign(
                    {
                        shiftName: 'BBBBBB',
                        startHour: 1,

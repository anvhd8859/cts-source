...
import { CancelInvoiceComponent } from 'app/entities/ctsmicroservice/cancel-invoice/cancel-invoice.component';
...
describe('Component Tests', () => {
    describe('CancelInvoice Management Component', () => {
        let comp: CancelInvoiceComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CancelInvoiceComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.cancelInvoices[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });

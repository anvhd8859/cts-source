...
import { IOffice, Office } from 'app/shared/model/ctsmicroservice/office.model';
...
describe('Service Tests', () => {
    describe('Office Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Office(0, 'AAAAAAA', 'AAAAAAA', 0, currentDate, currentDate);
        });

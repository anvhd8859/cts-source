...
import { SubDistrictComponent } from 'app/entities/ctsmicroservice/sub-district/sub-district.component';
    ...
    describe('SubDistrict Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SubDistrictComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.subDistricts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
